...
namespace swiftpay_api.Database.Migrations.Primary
{
    ...
    [Migration("20260221183233_AddUserAchievements")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("swiftpay_api_core.Models.Database.MerchantAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MerchantId", "AchievementId", "Environment")
                        .IsUnique();

                    b.ToTable("MerchantAchievements");
                });
            ...
            modelBuilder.Entity("swiftpay_api_core.Models.Database.User", b =>
                {
                    ...
                    b.Property<Guid?>("SelectedEmblemAchievementId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SelectedEmblemAchievementId");
            ...
            modelBuilder.Entity("swiftpay_api_core.Models.Database.UserRankingCache", b =>
                {
                    ...
                    b.Property<string>("SelectedEmblemUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("swiftpay_api_core.Models.Database.User", b =>
                {
                    ...
                    b.HasOne("swiftpay_api_core.Models.Database.Achievement", "SelectedEmblemAchievement")
                        .WithMany()
                        .HasForeignKey("SelectedEmblemAchievementId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SelectedEmblemAchievement");
                });
            ...
            modelBuilder.Entity("swiftpay_api_core.Models.Database.Achievement", b =>
                {
                    b.Navigation("MerchantAchievements");
