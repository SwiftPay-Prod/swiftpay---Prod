...
{
    public UserLevelData LevelInfo { get; set; } = null!;
    public List<UserAchievementItemData> Achievements { get; set; } = [];
...
public sealed class UserLevelData
{
...
public sealed class UserAchievementItemData
{
