...
namespace safefy_api.Database.Migrations.Primary
{
    ...
    [Migration("20260202215504_AddGrowthRatesToMerchantDashboardCache")]
    partial class AddGrowthRatesToMerchantDashboardCache
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("safefy_api_core.Models.Database.MerchantEmailTemplate", b =>
                {
                    ...
                    b.Property<string>("ItemsSectionTitle")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
