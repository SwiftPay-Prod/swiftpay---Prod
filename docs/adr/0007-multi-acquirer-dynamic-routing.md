...
O motor de pagamentos `swiftpay-api-payment` distribui requisições de cobrança (Pix, Cartão e Boleto) dinamicamente entre múltiplos provedores e adquirentes (ex: Akkadpag).
