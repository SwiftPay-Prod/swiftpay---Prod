		...
		<div className="sticky top-0 z-30 shrink-0 bg-card border-b border-border">
			<header className="flex items-center justify-between px-6 py-3">
				<div className="flex items-center gap-3 min-w-0">
					<SwiftPayBrandLogo iconSize={32} showText={true} />
					...
					<div className="min-w-0">
						<div className="text-sm font-semibold text-foreground truncate">
							{selectedMerchant?.name ?? 'Carregando...'}
						</div>
				...
				<div className="flex items-center gap-2 shrink-0">
					...
					<button
						type="button"
						className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-danger bg-danger/10 hover:bg-danger/20 rounded-md transition-colors"
					>
