...
const ICON_MAP: Record<IconName, ReactNode> = {
  ...
  NotificationSquare: <Icon icon={NotificationSquareIcon} className="icon-md" />,
  DocumentText: <Icon icon={File01Icon} className="icon-md" />,
  MoneyBag: <Icon icon={Wallet03Icon} className="icon-md" />,  Banknote: <Icon icon={BankIcon} className="icon-md" />,
