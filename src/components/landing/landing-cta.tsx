	...
	return (
		<section className="relative py-16 sm:py-24 bg-[#000000] border-t border-white/10 text-white">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				<div className="rounded-3xl border border-white/12 bg-card p-8 sm:p-16 text-center space-y-8 relative overflow-hidden">
					{/* Subtle Top Cobalt Border Highlight */}
					<div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-brand to-transparent opacity-80" />

					<div className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-surface-deep px-4 py-1.5 text-xs font-semibold text-link">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
						<button
							...
							className="group flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-base font-bold text-black hover:bg-white/90 active:scale-[0.98] transition-all cursor-pointer"
						>
