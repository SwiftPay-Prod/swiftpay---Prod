			...
			{Array.from({ length: intensity.diamondDustItems }).map((_, index) => {
				...
				return (
					<span
						...
						className="absolute flex size-4 items-center justify-center text-xs text-cyan-100 opacity-0 drop-shadow-[0_0_10px_rgba(255,255,255,0.65)]"
						style={{
							left: `${left}%`,
							top: `${top}%`,
			...
			{Array.from({ length: intensity.wealthItems }).map((_, index) => {
				...
				return (
					<span
						...
						className={isCoin
							? 'absolute left-1/2 top-[58%] flex size-9 items-center justify-center rounded-full border border-yellow-200/55 bg-linear-to-br from-yellow-300/80 via-amber-300/85 to-yellow-500/85 text-xs font-black text-amber-950 opacity-0 shadow-[0_14px_30px_rgba(250,204,21,0.3)]'
							: 'absolute left-1/2 top-[58%] rounded-full border border-emerald-200/30 bg-black/30 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-emerald-50 opacity-0 shadow-[0_14px_30px_rgba(16,185,129,0.18)] backdrop-blur-md'}
						style={{
			...
			{Array.from({ length: intensity.moneyRainItems }).map((_, index) => {
				...
				return (
					<span
						...
						className={isBill
							? 'absolute top-[-12%] rounded-2xl border border-emerald-200/35 bg-linear-to-br from-emerald-300/85 via-emerald-400/75 to-teal-500/75 px-3 py-1.5 text-xs font-black tracking-[0.22em] text-emerald-950 opacity-0 shadow-[0_16px_28px_rgba(16,185,129,0.28)]'
							: 'absolute top-[-12%] flex size-10 items-center justify-center rounded-full border border-yellow-100/55 bg-linear-to-br from-yellow-300/90 via-amber-300/85 to-yellow-500/90 text-xs font-black text-amber-950 opacity-0 shadow-[0_16px_30px_rgba(245,158,11,0.3)]'}
						style={{
							left: `${left}%`,
