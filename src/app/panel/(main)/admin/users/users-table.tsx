...
function getColumns(config: {
	...
	return [
		...
		},
		{
			...
			render: (user) => <span className="text-sm font-bold font-mono text-success tabular-nums">{formatCurrency(user.generatedReferralCommission)}</span>,
		},
		{
			key: 'availableCommissionBalance',
			header: 'Saldo comissão',
			render: (user) => <span className="text-sm font-bold font-mono text-link tabular-nums">{formatCurrency(user.availableCommissionBalance)}</span>,
		},
		{
			key: 'createdAt',
			header: 'Criado em',
		...
		>
			<div className="flex flex-col gap-2">
				...
				<div className="flex items-center justify-between gap-2">
					...
					<span className="text-sm font-bold font-mono text-success tabular-nums">{formatCurrency(user.generatedReferralCommission)}</span>
				</div>
			...
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
				...
				<div className="rounded-[20px] border border-white/12 bg-card p-5 flex flex-col justify-between gap-3">
					...
					<div>
						...
						<p className="text-xs text-success/80 font-mono mt-0.5">Habilitados</p>
					</div>
				</div>
				...
				<div className="rounded-[20px] border border-white/12 bg-card p-5 flex flex-col justify-between gap-3">
					...
					<div>
						<span className="text-2xl font-extrabold font-mono text-link tracking-tight tabular-nums block">
