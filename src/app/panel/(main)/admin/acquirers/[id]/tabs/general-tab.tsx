...
interface FeatureSupportRowProps {
	label: string;
	supported: boolean;
}

function FeatureSupportRow({ label, supported }: FeatureSupportRowProps) {
	return (
		<div className="flex items-center justify-between">
			<span className="text-sm">{label}</span>
			<Chip variant="soft" color={supported ? 'success' : 'default'} size="sm">
